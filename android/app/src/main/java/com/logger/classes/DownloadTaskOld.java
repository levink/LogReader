...
//
//public class DownloadTaskOld implements Runnable {
//
...
//
//    private DownloadTaskOld(String url, String mask) {
//        this.url = url;
//        this.mask = mask;
//        this.writer = App.createLogWriter();
//        this.paused = false;
//        this.stopTime = 0;
...
//
//
//    private static DownloadTaskOld task = null;
//    public static DownloadTaskOld getOrCreate(String url, String mask) {
//        if (task == null) {
//            task = new DownloadTaskOld(url, mask);
//            return task;
//        }
//
//        if (task.isComplete()) {
